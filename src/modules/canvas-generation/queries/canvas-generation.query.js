...
export const UPDATE_CANVAS_GENERATION_STATUS =
  "UPDATE canvas_generations SET generation_status = ?, error_code = ?, failure_message = ?, updated_by = ? WHERE id = ? AND deleted = FALSE";
